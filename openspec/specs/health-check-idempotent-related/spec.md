# health-check-idempotent-related Specification

## Purpose
Health check replaces the Related section on every run (idempotent) and preserves user-curated links in a separate Manual Links section.
