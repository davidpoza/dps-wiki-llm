...
El sistema SHALL mantener todos los prompts usados internamente en la tabla `llm_prompts`, con una clave única por prompt, nombre legible y texto. La tabla SHALL ser inicializada mediante migración Flyway con los valores actuales como datos por defecto.
