# tree-reveal-active-file Specification

## Purpose
Auto-reveal and scroll the file-tree panel to the active file when a note is opened programmatically (URL navigation, global search, link clicks, history/jobs views).
