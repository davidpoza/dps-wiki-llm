...
- [ ] 8.2 Lanzar el escaneo y comprobar que el progreso se actualiza en tiempo real
- [ ] 8.3 Al terminar, verificar que el modal se abre con la lista de broken links y los checkboxes marcados
- [ ] 8.4 Desmarcar algún enlace, hacer clic en "Eliminar" y verificar que solo se eliminan los marcados
- [ ] 8.5 Relanzar el escaneo y comprobar que los enlaces eliminados ya no aparecen
- [ ] 8.6 Verificar que si no hay broken links aparece el mensaje inline "No se encontraron enlaces rotos"
