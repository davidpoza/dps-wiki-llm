...
- [x] 7.2 `docker compose up` and ingest representative real URLs (including a JS-heavy SPA and a site that blocks non-browser clients); inspect produced `raw/web/**` markdown for fidelity
