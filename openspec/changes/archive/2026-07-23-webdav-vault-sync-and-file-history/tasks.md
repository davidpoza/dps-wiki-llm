...
- [x] 11.1 End-to-end: edit a file → verify local write, history entry, and WebDAV replication
- [x] 11.2 End-to-end: change a file remotely → Sync → verify pull + `WEBDAV_PULL` history entry
- [x] 11.3 End-to-end: change a file both locally and remotely → Sync → resolve conflict both ways
- [x] 11.4 End-to-end: preview and restore a prior version from the editor
