...
- [x] 5.1 Arrancar backend y comprobar que `GET /api/settings/reindex` devuelve stream SSE con eventos `progress` y `done`
- [x] 5.2 Arrancar frontend y verificar que el botón "Reindexar" actualiza el contador en tiempo real hasta completar
- [x] 5.3 Verificar que el botón vuelve a activarse y muestra el mensaje de éxito al terminar
- [x] 5.4 Verificar que el mensaje de éxito desaparece a los 5 segundos
