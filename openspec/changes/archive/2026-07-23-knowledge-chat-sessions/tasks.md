...
- [x] 8.1 Verificar en la app que crear una nueva conversación, enviar una pregunta y recibir respuesta funciona correctamente
- [x] 8.2 Verificar que el historial de sesiones persiste tras recargar la página
- [x] 8.3 Verificar que seleccionar una sesión pasada carga el historial de mensajes
- [x] 8.4 Verificar que el botón "Guardar en vault" crea el archivo y muestra el path
- [x] 8.5 Verificar que borrar una sesión la elimina del sidebar
- [x] 8.6 Verificar que el bot de Telegram sigue funcionando con el endpoint `/api/answer` sin cambios
