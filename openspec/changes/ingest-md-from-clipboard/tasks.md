...
- [ ] 5.2 Verificar que pegar un MD real encola el job y muestra el jobId
- [x] 5.3 Verificar que se muestra el aviso de tamaño al superar 2 MB
- [ ] 5.4 Verificar con curl/Postman que `POST /api/ingest/text` responde 202 con contenido válido y 400 con contenido vacío o > 2 MB
