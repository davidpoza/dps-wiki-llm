...
services:
  n8n:
    ...
    environment:
      ...
      - LLM_MODEL=${LLM_MODEL}
      - LLM_ANSWER_TEMPERATURE=${LLM_ANSWER_TEMPERATURE:-0.2}
      - EMBED_MODEL=${EMBED_MODEL}
      - EMBED_MAX_OLD_SPACE_MB=${EMBED_MAX_OLD_SPACE_MB:-3072}
      - LOG_LEVEL=${LOG_LEVEL:-info}
      - N8N_BLOCK_ENV_ACCESS_IN_NODE=${N8N_BLOCK_ENV_ACCESS_IN_NODE}
      - TELEGRAM_BOT_TOKEN=${TELEGRAM_BOT_TOKEN}
      - TELEGRAM_CHAT_ID=${TELEGRAM_CHAT_ID}
      - TELEGRAM_BOT_LOCK_TTL_MS=${TELEGRAM_BOT_LOCK_TTL_MS:-1800000}
...
EMBED_MODEL=<optional; defaults to Xenova/multilingual-e5-small>
EMBED_MAX_OLD_SPACE_MB=<optional; Node heap limit for embed-index in MB; defaults to 3072>
