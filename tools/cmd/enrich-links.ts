...
import { resolveVaultRoot, relativeVaultPath } from "../lib/storage/fs-utils.js";
import { loadWikiDocs, analyzeWikiGraph } from "../lib/wiki/wiki-inspect.js";
import { loadManifest, loadAllEmbeddingUnits, cosineSimilarity } from "../lib/storage/semantic-index.js";
...
import type { MutationPlan, MutationResult, WikiDoc } from "../lib/core/contracts.js";
