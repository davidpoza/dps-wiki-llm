...
/**
 * Per-file change history. Replaces the previous commit-grouped snapshot view: history is now a
 * flat, reverse-chronological stream of individual file changes.
 */
@RestController
