...
/**
 * Per-file WebDAV replication baseline. {@code syncedHash} is the SHA-256 of the
 * content last known to match the remote; comparing it against the current local
 * and remote hashes during Sync is how conflicts are detected.
 */
@Entity
...
public class VaultFileSync {
    ...
    public String getSyncedHash() { return syncedHash; }
    public void setSyncedHash(String syncedHash) { this.syncedHash = syncedHash; }
