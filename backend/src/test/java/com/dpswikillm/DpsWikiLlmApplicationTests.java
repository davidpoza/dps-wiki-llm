...
class DpsWikiLlmApplicationTests {
    ...
    @MockBean DocumentIndexRepository documentIndexRepository;

    @MockBean JobRepository jobRepository;

    @MockBean JobConnectionCandidateRepository jobConnectionCandidateRepository;

    @MockBean OperationRepository operationRepository;

    @MockBean LlmPromptRepository llmPromptRepository;
    ...
    @MockBean SnapshotFileRepository snapshotFileRepository;

    @MockBean VaultFileSyncRepository vaultFileSyncRepository;

    @MockBean ChatSessionRepository chatSessionRepository;
